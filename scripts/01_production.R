...
facs<-c('UK', 'Chile', 'Norway')
cols<-c('UK' = '#DB72FB', 'Chile' = '#D39200', 'Norway' = '#00B9E3', 'Other' = 'grey')
...
ggplot(prod, aes(year ,tonnes, col=country, group=country_name)) + geom_line() +
    ...
    scale_x_continuous(expand=c(0,0), limits=c(1960, 2026)) +
